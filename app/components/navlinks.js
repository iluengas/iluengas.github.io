  ...
  return (
    <div className="flex justify-center text-white"> {/* Center the content */}
      <ul className="hidden sm:flex items-center text-center">
        ...
        <li className="">
          <a href={resumeUrl} target="_blank" rel="noopener noreferrer" className=" px-4 py-4 flex relative rounded-lg group text-white text-lg font-bold items-center space-x-1">
