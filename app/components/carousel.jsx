                ...
                <Slider {...settings} className=' w-full md:w-4/5'>
                    <div className='slick-slide w-full'>
                        ...
                        <div className='project-card border border-gray-900 md:border-none'>
                            <div className=" w-full md:w-96 h-32 md:h-full flex flex-col items-center md:justify-start md:mr-4 p-1">
                                ...
                                <img src="./Gallo.jpg" alt="gallo" style={{ width: '100px', height: '100px' }} className='' />
                            </div>
                                ...
                                <div className=' m-1 w-full'>
                                    <ul className='p-1 flex flex-wrap text-xs md:text-xl w-full'>
                                        <li className='flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./reactnative.png" style={{ width: '20px', height: '20px' }} className='mr-1' />React Native
                                        </li>
                                        <li className='flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./Python.png" style={{ width: '20px', height: '20px' }} className='mr-1' />Python
                                        </li>
                                        <li className=' flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./sql.png" style={{ width: '20px', height: '20px' }} className='mr-1' />SQlite3
                                        </li>
                                        <li className=' flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./Python.png" style={{ width: '20px', height: '20px' }} className='mr-1' />Flask
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className='slick-slide'>
                        ...
                        <div className='project-card border border-gray-900 md:border-none'>
                            <div className=" w-full md:w-96 h-32 md:h-full flex flex-col items-center md:justify-start md:mr-4 p-1">
                                <h2 className=' h-full md:h-max md:mb-10 text-sm md:text-lg'>Jan - May 2023 </h2>
                                <img src="./hand.png" alt="gallo" style={{ width: '100px', height: '100px' }} className='' />
                            </div>
                            <div className=' w-full h-2/3 md:h-full md:flex md:flex-col md:justify-start'>
                                <div className=''>
                                    <h2 className="text-md md:text-2xl font-medium md:mb-2 md:flex md:justify-start">
                                ...
                                <div className=' m-1 w-full'>
                                    <ul className='p-1 flex flex-wrap text-xs md:text-xl w-full'>
                                        <li className='flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./csharp.png" style={{ width: '20px', height: '20px' }} className='mr-1' />C#
                                        </li>
                                        <li className='flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./Python.png" style={{ width: '20px', height: '20px' }} className='mr-1' />Python
                                        </li>
                                        <li className=' flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./unity.png" style={{ width: '20px', height: '20px' }} className='mr-1' />Unity
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className='slick-slide'>
                        ...
                        <div className='project-card border border-gray-900 md:border-none'>
                            <div className=" w-full md:w-96 h-32 md:h-full flex flex-col items-center md:justify-start md:mr-4 p-1">
                                <h2 className=' h-full md:h-max md:mb-10 text-sm md:text-lg'>Jan - May 2023 </h2>
                                <img src="./weatherapp.png" alt="gallo" style={{ width: '100px', height: '100px' }} className='' />
                            </div>
                            <div className=' w-full h-2/3 md:h-full md:flex md:flex-col md:justify-start'>
                                <div className=''>
                                    <h2 className="text-md md:text-2xl font-medium md:mb-2 md:flex md:justify-start">
                                ...
                                <div className=' m-1 w-full'>
                                    <ul className='p-1 flex flex-wrap text-xs md:text-xl w-full'>
                                        <li className='flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./python.png" style={{ width: '20px', height: '20px' }} className='mr-1' />Tkinter
                                        </li>
                                        <li className='flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./Python.png" style={{ width: '20px', height: '20px' }} className='mr-1' />Python
                                        </li>
                                        <li className=' flex justify-center items-center m-1 rounded-2xl bg-gray-900 w-max p-2 shadow-sm shadow-gray-100'>
                                            <img src="./api.png" style={{ width: '20px', height: '20px' }} className='mr-1 ' />API's
                                        </li>
                                    </ul>
                                </div>
                            </div>
