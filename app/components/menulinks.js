...
function MenuLinks({ isOpen, toggleMenu, resumeUrl, linkedinUrl, githubUrl }) {
  ...
  return (
    <div
      className="fixed inset-0 text-white flex bg-black bg-opacity-99"
      style={{ zIndex: 1 }}
    >
      ...
      <ul
        className=" mt-14 h-screen flex flex-col bg-black items-center bg-r py-12 w-full font-semibold text-2xl"
